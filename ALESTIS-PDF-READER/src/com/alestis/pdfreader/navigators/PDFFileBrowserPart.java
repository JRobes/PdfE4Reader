package com.alestis.pdfreader.navigators;
...
import es.robes.imageloader.IImageLoader;
		...
		viewer.addDoubleClickListener(new IDoubleClickListener() {
		      ...
		      public void doubleClick(DoubleClickEvent event) {
		          ...
		          if (selection.getFirstElement() instanceof File ) {
		        	  ...
		        	  System.out.println("Directorio selecionado, getParent():" + file.getParent());
		              ...
		              if (!partExists) {
		                  MPart part2 = partService.createPart("alestis-pdf-reader.partdescriptor.pdfeditor");
		                  MPartStack stack = (MPartStack)modelService.find("alestis-pdf-reader.partstack.pdf", application);
		                  stack.getChildren().add(part2);
		                 // partService.activate(part2);
		                  //part2.setLabel(file.getName());
		                  System.out.println("Part No EXISTE");
