 ...
 *
 */
public class PDFPageViewer extends Canvas implements PaintListener{
    /** The image of the rendered PDF page being displayed  oo  */
    ...
    public PDFPageViewer(Composite parent) {
    	...
    	this.addMouseListener(new MouseListener() {
			...
			public void mouseDoubleClick(org.eclipse.swt.events.MouseEvent e) {
				...
				//ESTO HAY QUE CAMBIAR O SABER QUE HACE....
				/*
				Display.getDefault().asyncExec(new Runnable() {
		...
		//Hay que cambiar posteriormente
...
/*    	if (currentPage != null && prevSize != null && currentPage.isFinished()) {
    ...
    //ESTE METODO ES PARA EL IPreferencechagelistener
    /*
    @Override
